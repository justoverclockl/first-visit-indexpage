        ...
        m(".sideNavContainer", [
          m(".IndexPage-results.sideNavOffset",
            m("div", {className:"body-post"},
              [
                m("section", {className:"timeline-outer",id:"timeline"},
                  m("div", {className:"container",id:"content"},
                    m("div", {className:"row"},
                      m("div", {className:"col s12 m12 l12"},
                        [
                          m("h1", {className:"blue-text lighten-1 header"},
                            "Steps to become a good user"
                          ),
                          m("ul", {className:"timeline"},
                            [
                              m("li", {className:"event"},
                                [
                                  m("h3",
                                    "Management and Entreprenurship (MSc)"
                                  ),
                                  m("p",
                              ...
                              m("li", {className:"event"},
                                [
                                  m("h3",
                                    "Games & Multimedia Environments BSc (Hons)"
                                  ),
                                  m("p",
